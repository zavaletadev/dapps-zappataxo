...
public class ProductoOriginalAdapter extends BaseAdapter {

    private Context contexto;
    private JSONArray datos;
    private LayoutInflater inflater;

    public ProductoOriginalAdapter(Context contexto, JSONArray datos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_producto_original, null);
        }
